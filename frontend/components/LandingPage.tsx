...
// Component for the new Core Principles section
  ...
  const corePrinciples = [
    {
      ...
      title: t('landingPage.principle_aadhaar_title'),
      description: t('landingPage.principle_aadhaar_desc'),
    },
    {
      icon: <FileText className="w-10 h-10" />,
      title: t('landingPage.principle_apaar_title'),
      description: t('landingPage.principle_apaar_desc'),
    },
    {
      icon: <Building2 className="w-10 h-10" />,
      title: t('landingPage.principle_aishe_title'),
      description: t('landingPage.principle_aishe_desc'),
    },
    {
      icon: <Database className="w-10 h-10" />,
      title: t('landingPage.principle_datahub_title'),
      description: t('landingPage.principle_datahub_desc'),
    },
  ];
    ...
    <section className="py-20 px-4">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: accentGray }}>
          {t('landingPage.principles_title')}
        </h2>
        <p className="text-xl max-w-2xl mx-auto" style={{ color: textGray }}>
          {t('landingPage.principles_subtitle')}
        </p>
      </motion.div>
      <motion.div
      ...
      >
        {corePrinciples.map((principle, index) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-3" style={{ color: accentGray }}>{principle.title}</h3>
            <p className="text-base" style={{ color: textGray }}>{principle.description}</p>
          </motion.div>
        ))}
      </motion.div>
    </section>
...
export function LandingPage() {
  ...
  const stats = [
    { number: "10M+", label: t("landingPage.stat_10M+"), icon: <Users size={24} /> },
    { number: "5K+", label: t("landingPage.stat_5K+"), icon: <Building2 size={24} /> },
    { number: "100%", label: t("landingPage.stat_100%"), icon: <CheckCircle size={24} /> },
    { number: "20+", label: t("landingPage.stat_20+"), icon: <DollarSign size={24} /> },
  ];
  ...
  const howItWorks = [
    ...
    },
    {
      image: statsImage,
      icon: <Trophy size={48} />,
      title: t("landingPage.step_track_title"),
      description: t("landingPage.step_track_desc")
    },
    {
      image: ctaImage,
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: bgColor }}>
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-6">
              ...
              >
                ...
                <div>
                  <h1 className="text-xl font-bold" style={{ color: accentGray }}>Viksit Shiksha</h1>
              ...
              >
                ...
                <Link
                  to="/auth"
                  className="px-4 py-2 hover:text-gray-900 transition-colors font-medium"
                ...
                <Link
                  to="/auth"
                  className="px-6 py-2 text-white rounded-lg hover:brightness-110 transition-colors font-semibold shadow-md"
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  to="/auth"
                  className="px-8 py-4 text-white rounded-lg text-lg font-semibold hover:brightness-110 transition-colors shadow-lg flex items-center justify-center"
                  style={{ backgroundColor: primaryBlue }}
                >
        ...
        <section className="py-20 px-4" style={{ backgroundColor: lightBlue }}>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: accentGray }}>
              {t('landingPage.video_title')}
            </h2>
            <p className="text-xl max-w-2xl mx-auto" style={{ color: textGray }}>
              {t('landingPage.video_subtitle')}
            </p>
          </motion.div>
        ...
        <section className="py-20 px-4 relative" style={{ backgroundColor: primaryBlue }}>
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <Link
                to="/auth"
                className="inline-block px-8 py-4 bg-white text-lg font-semibold rounded-lg hover:bg-gray-100 transition-colors shadow-xl flex items-center justify-center mx-auto max-w-xs"
                style={{ color: primaryBlue }}
              >
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-lg font-semibold">Viksit Shiksha</span>
                </div>
